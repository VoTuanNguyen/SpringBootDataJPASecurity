...
public class UserRestController {
	...
	public ResponseEntity<String> gettoken(HttpServletRequest request) {
		String result = "";
		String json = "eyJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NDA0Njc1NTEsInVzZXJuYW1lIjoic2VuYSJ9.eQBizL21c2FRlJeIiWo-Vak-V-0sfme71rc3VYQxZx4";
//		ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
		result = jwtService.getUsernameFromToken(json);
